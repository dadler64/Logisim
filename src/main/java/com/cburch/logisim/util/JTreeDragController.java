...
public interface JTreeDragController {
    ...
    boolean canPerformAction(JTree target, Object draggedNode, int action, Point location);

    boolean executeDrop(JTree tree, Object draggedNode, Object newParentNode, int action);
}
